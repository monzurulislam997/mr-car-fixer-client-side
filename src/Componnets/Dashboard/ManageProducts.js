...
export default function ManageProducts() {
    const { data, isLoading, refetch } = useQuery(['products'], () => axios.get(`https://murmuring-coast-74954.herokuapp.com/api/services`, {
        headers: {
    ...
    const deleteProduct = (id) => {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                axios.delete(`https://murmuring-coast-74954.herokuapp.com/api/services/${id}`, {
                    headers: {
                        authorization: `Bearer ${localStorage.getItem('aceessToken')}`
                    }
                })
