...
export default function AllOrders() {
    const { data, refetch, isLoading } = useQuery(['available',], () => axios.get(`https://murmuring-coast-74954.herokuapp.com/api/orders`, {
        headers: {
    ...
    const cancelOrder = (id, quantity) => {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                axios.delete(`https://murmuring-coast-74954.herokuapp.com/api/orders/${id}`, {
                    headers: {
                        authorization: `Bearer ${localStorage.getItem('aceessToken')}`
                    }
                })
                    .then(res => {
                        ...
                        axios.get(`https://murmuring-coast-74954.herokuapp.com/api/service/${id}`, {
                            headers: {
                                authorization: `Bearer ${localStorage.getItem('aceessToken')}`
                            }
                        })
                            .then(res => {
                                ...
                                axios.patch(`https://murmuring-coast-74954.herokuapp.com/api/service/${id}`, {
