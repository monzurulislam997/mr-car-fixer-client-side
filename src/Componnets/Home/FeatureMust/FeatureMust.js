    ...
    const services = [
        {
            ...
            icon: <MdMultipleStop class="h-12 w-10 text-indigo-600" />
        },
        {
            _id: 2,
            name: 'Car bulbs',
            description: 'Car bulbs are used to light the car.',
            icon: <HiLightBulb class="h-10 w-10 text-yellow-400" />
        },
        {
            _id: 3,
            name: 'Air Filters',
        ...
        },
        {
            ...
            icon: <RiOilFill class="h-10 w-10 text-emerald-400" />
        },
        {
            _id: 5,
            name: 'Spark Plugs',
            description: 'Spark plugs are used to start the engine.',
            icon: <GiFlintSpark class="h-10 w-10 text-red-900" />
        }
    ]
    return (
        <>
            <div class="text-center mt-16">
                <h1 className=" font-bold  text-3xl text-cyan-700">EMERGENCY KIT TO KEEP IN A CAR</h1>
                <p className=" text-slate-500 m-5">Enjoy an entirely new level of driving experience with our in-depth selection of superior car bulbs, brake pads, spark plugs, and other automotive parts and accessories designed to keep your car running at its absolute best.</p>
            </div>
