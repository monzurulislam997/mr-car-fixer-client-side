...
/*
    admin log in:
   email: monzurulislam997@gmail.com
   pass: 123456MM
    ...
    return (
        <div class="flex h-screen justify-center items-center px-4 lg:px-12">
            ...
            <div class="card w-96 bg-slate-50/60 backdrop-blur-2xl transition-colors duration-500">
                <h1 className="text-center text-2xl font-bold mt-5">Log In </h1>
                <div class="card-body">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <small class="font-bold"> Don't have an account?  <Link to="/register" className="ml-2 text-blue-500"> Create an account! </Link></small>
                    </form>
