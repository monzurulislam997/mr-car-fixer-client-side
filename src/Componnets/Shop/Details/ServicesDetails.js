...
export default function ServicesDetails() {
    ...
    const { data: services, refetch, isLoading, error } = useQuery(['available',], () => axios.get(`https://murmuring-coast-74954.herokuapp.com/api/service/${id}`, {
        headers: {
    ...
    const onSubmit = data => {
        ...
        console.log(newData);
        axios.post(`https://murmuring-coast-74954.herokuapp.com/api/orders`, newData, {
            headers: {
                authorization: `Bearer ${localStorage.getItem('aceessToken')}`
            }
        })
            .then(res => {
                if (res.status === 200) {
                    ...
                    axios.put(`https://murmuring-coast-74954.herokuapp.com/api/services/${id}`, { availableQty: newAvailableQty }, {
                        headers: {
                            authorization: `Bearer ${localStorage.getItem('aceessToken')}`
                        }
                    })
